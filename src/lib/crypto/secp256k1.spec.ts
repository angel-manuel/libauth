...
// prettier-ignore
// const pubkeys = [pubkeyCompressed, pubkeyUncompressed]

// prettier-ignore
// const combinedPubkeyCompressed = pubkeyCompressed
...
// test('[crypto] secp256k1.combinePubkeysCompressed', async (t) => {
//   const secp256k1 = await secp256k1Promise;
//   t.deepEqual(
//     secp256k1.combinePublicKeysCompressed(pubkeys),
//     combinedPubkeyCompressed
//   );
// });
